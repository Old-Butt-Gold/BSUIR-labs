...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        hCustomListView = new CustomTable(hwnd, CUSTOM_LIST_VIEW_ROW_COUNT, CUSTOM_LIST_VIEW_COL_COUNT);
    ...
    case WM_CELL_CLICK: 
    {
        ...
        std::wstring message = L"Cell Clicked - Item: " + std::to_wstring(itemIndex) +
    ...
    case WM_CELL_RCLICK: 
    {
        ...
        std::wstring message = L"Cell Right Clicked - Item: " + std::to_wstring(itemIndex) +
            L", Column: " + std::to_wstring(columnIndex);
    ...
    case WM_CELL_DBLCLICK: 
    {
        ...
        std::wstring message = L"Cell Double Clicked - Item: " + std::to_wstring(itemIndex) +
            L", Column: " + std::to_wstring(columnIndex);
    ...
    case WM_CELL_RDBLCLICK: 
    {
        ...
        std::wstring message = L"Cell Right Double Clicked - Item: " + std::to_wstring(itemIndex) +
            L", Column: " + std::to_wstring(columnIndex);
    ...
    case WM_HEADER_CLICK: 
    {
        ...
        std::wstring message = L"Header Clicked - Column: " + std::to_wstring(columnIndex);
    ...
    case WM_HEADER_RCLICK: 
    {
        ...
        std::wstring message = L"Header Right Clicked - Column: " + std::to_wstring(columnIndex);
    ...
    case WM_HEADER_DBLCLICK:
    {
        ...
        MessageBox(hwnd, (L"Double Left Click on Header " + std::to_wstring(columnIndex)).c_str(), L"Header Event", MB_OK);
    }
    break;
    ...
    {
        int columnIndex = static_cast<int>(wParam);
        MessageBox(hwnd, (L"Double Right Click on Header " + std::to_wstring(columnIndex)).c_str(), L"Header Event", MB_OK);
    }
    break;
