...
void PrepareListView(Table* hListView, HWND hEdit)
{
...
void SortListView(Table* hListView, bool isAscending)
{
...
LRESULT CALLBACK WindowProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        for (int i = 0; i < CUSTOM_LIST_VIEW_ROW_COUNT; ++i) {
            ...
            // ���������� ������ � ������ �������
            hCustomListView->AddItem(i, 0, fileName); // ��� ����� � ������� 1
            hCustomListView->AddItem(i, 1, fileSize); // ��� ����� � ������� 1
            hCustomListView->AddItem(i, 2, fileSize); // ������ ����� � ������� 3
            hCustomListView->AddItem(i, 3, fileName); // ������ ����� � ������� 3
            hCustomListView->AddItem(i, 4, fileName); // ������ ����� � ������� 3
            hCustomListView->AddItem(i, 5, fileSize); // ������������� ������ ����� � ������� 5 (���� ����� ��)
        }
